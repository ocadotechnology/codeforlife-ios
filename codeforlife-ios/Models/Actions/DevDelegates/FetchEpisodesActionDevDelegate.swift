//
//  FetchEpisodesActionDevDelegate.swift
//  codeforlife-ios
//
...
class FetchEpisodesActionDevDelegate: ActionDelegate {
    
    var url = "https://dev-dot-decent-digit-629.appspot.com/rapidrouter/api/episodes/"
