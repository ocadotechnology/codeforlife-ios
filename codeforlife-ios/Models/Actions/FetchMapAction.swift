            ...
            for decoration in levelDecorSet {
                if let x = decoration["x"].int,
                    ...
                    decorName = decoration["decorName"].string {
                        var posX = CGFloat(x) * GameMapConfig.DecorationXRatio + GameMapConfig.Grid.width * GameMapConfig.DecorationYOffsetRatio
                        var posY = CGFloat(y) * GameMapConfig.DecorationXRatio + GameMapConfig.Grid.height * GameMapConfig.DecorationXOffsetRatio
...
//    deinit {
//        println("FetchMapAction is being deallocated")
//    }
