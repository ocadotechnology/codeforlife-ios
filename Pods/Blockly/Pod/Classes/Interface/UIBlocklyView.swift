...
public class UIBlocklyView: UIView {
...
//        Workspace.getInstance().blocklys.append(self.blockly)
    ...
    private func calculateFrameHeight() -> CGFloat {
        let result = max(DefaultBlocklySize.height, inputs.reduce(0, combine: {$0 + $1.totalHeight}))
