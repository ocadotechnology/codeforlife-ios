...
public class Input: UIView {
    ...
    var targetBlockly: UIBlocklyView? {
        return connectionPoint?.connection.targetConnection?.sourceBlockly.blocklyView
    }
    ...
    var totalHeight: CGFloat {
        if let inputConnection = connectionPoint?.connection as? InputConnection {
            ...
            case is InputValueConnection:
                if let targetBlockly = connectionPoint?.connection.targetConnection?.sourceBlockly.blocklyView {
